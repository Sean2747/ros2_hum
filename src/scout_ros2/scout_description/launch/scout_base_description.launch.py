...
def generate_launch_description():
    ...
    xacro_file = os.path.join(get_package_share_directory("scout_description"), "urdf", "scout_v2.xacro")
    xacro_config = xacro.process_file(xacro_file)
    robot_description_content = xacro_config.toxml()
